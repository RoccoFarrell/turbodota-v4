							...
							<div class="journey-step" class:journey-step--claimed={claimed} class:journey-step--active={isNext || quest.canClaim} class:journey-step--locked={quest.locked && !claimed}>
								...
								<div class="journey-content">
									<div class="flex items-center gap-2 flex-wrap">
										...
										{#if claimed}
											<span class="text-[10px] uppercase tracking-wider text-amber-600 font-semibold">Claimed</span>
										{/if}
									</div>
								...
								<div class="bounty-details">
									<div class="flex items-center justify-between gap-2">
										<div class="flex items-center gap-2 flex-wrap">
											...
											{#if quest.canClaim}
												<span class="text-[10px] uppercase tracking-wider text-amber-400 font-bold animate-pulse">
													Complete!
												</span>
											{/if}
									...
									<!-- Metadata row -->
									<div class="flex items-center gap-3 mt-1 text-[11px] text-stone-600 flex-wrap">
										{#if quest.startedAt}
