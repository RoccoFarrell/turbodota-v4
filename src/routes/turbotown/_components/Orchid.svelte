<script lang="ts">
	...
	function onFormSubmit(inputSelectedTown: any): void {
		...
		const t: ToastSettings = {
			message: `Used Orchid Malevolence`,
...
<div class="flex flex-col justify-center items-center">
	<div id="orchidModal" class="h1 w-[50vw] card flex flex-col justify-center items-center p-4">
		<form method="POST" class="w-full" action="/turbotown?/useOrchid" use:enhance>
			...
			<div class="flex flex-col justify-center w-full space-y-4">
				<div class="w-full flex justify-center">
					<p class="italic text-tertiary-600 text-sm">
						Constructed from the essence of one of the most wicked foulfell demons, this staff is surely capable of inflicting serious punishment.
					</p>
				</div>
				<h2 class="h2 text-center text-success-500">Select Town to Apply Orchid Malevolence</h2>
