...
<div class="flex flex-col justify-center items-center">
	<div id="etherealBladeModal" class="h1 w-[50vw] card flex flex-col justify-center items-center p-4">
		<form method="POST" class="w-full" action="/turbotown?/useEtherealBlade" use:enhance>
			...
			<div class="flex flex-col justify-center w-full space-y-4">
				<div class="w-full flex justify-center">
					<p class="italic text-tertiary-600 text-sm">
						The blade flickers with a ghastly green aura.  A blade fit for a King...
					</p>
				</div>
				<h2 class="h2 text-center text-success-500">Select Town to Apply Ethereal Blade</h2>
