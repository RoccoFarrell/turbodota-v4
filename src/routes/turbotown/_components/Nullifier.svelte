...
<div class="flex flex-col justify-center items-center">
	<div id="nullifierModal" class="h1 w-[50vw] card flex flex-col justify-center items-center p-4">
		<form method="POST" class="w-full" action="/turbotown?/useNullifier" use:enhance>
			...
			<div class="flex flex-col justify-center w-full space-y-4">
				...
				<h2 class="h2 text-center text-success-500">Select Town to Apply Nullifier</h2>
