...
- **[PLANNING.md](./PLANNING.md)** - Complete feature specification (database, APIs, UI flow)
- **[DEVELOPMENT_ROADMAP.md](./DEVELOPMENT_ROADMAP.md)** - Incremental development strategy with bite-sized components
- **[TESTING_STRATEGY.md](./TESTING_STRATEGY.md)** - Comprehensive testing approach for complex interactions
- **[CARD_EXAMPLES.md](./CARD_EXAMPLES.md)** - Example card designs and balancing
- **[BATTLE_MECHANICS.md](./BATTLE_MECHANICS.md)** - Battle system and enemy AI patterns
- **[HERO_SPECIFICS.md](./HERO_SPECIFICS.md)** - Complete card designs for all 127 heroes
...
- Number of copies based on performance percentile:
...
- **Deck Building** - Build custom decks of up to 10 cards
...
**Core Models:**
- `BattlerCard` - Card definitions (one per hero)
- `UserBattlerCard` - User's card collection
- `BattlerDeck` - User's decks (up to 10 cards each)
...
See [CARD_EXAMPLES.md](./CARD_EXAMPLES.md) for more examples.
...
See [BATTLE_MECHANICS.md](./BATTLE_MECHANICS.md) for detailed enemy patterns.
...
- Can win same hero multiple times (future: upgrades)
- Prevents deck bloat

### 2. Fixed 10-Card Decks
...
- Boss at floor 10
- Linear scaling (health +10%, damage +5% per floor)
...
- Checks for wins since last claim
...
- **[DECISIONS_SUMMARY.md](./DECISIONS_SUMMARY.md)** - Quick reference for all decisions
- **[PRE_DEVELOPMENT_QUESTIONS.md](./PRE_DEVELOPMENT_QUESTIONS.md)** - Detailed Q&A
...
5. **Reset Prisma migration system** (before Phase 0)
6. Create database migration
7. Build MVP following DEVELOPMENT_ROADMAP.md
