...
-- AddForeignKey
ALTER TABLE "IncrementalSave" ADD CONSTRAINT "IncrementalSave_seasonId_fkey" FOREIGN KEY ("seasonId") REFERENCES "Season"("id") ON DELETE SET NULL ON UPDATE CASCADE;
